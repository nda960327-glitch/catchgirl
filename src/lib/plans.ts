...
export const POLICY: { title: string; body: string }[] = [
  ...
  },
  {
    title: "약정과 무약정",
    body:
      "무약정은 Pro 130,000원, Max 260,000원을 매달 내고 언제든 해지할 수 있어요. 위약금이 없어요.\n" +
      "2년 약정은 Pro 100,000원, Max 200,000원이고(23% 할인), 방문 세팅 300,000원도 무료예요. 24개월이 지나면 자동으로 무약정으로 이어지고, 약정을 다시 하면 같은 가격이에요.\n" +
      "약정을 중간에 해지하면 남은 기간을 다 물리지 않아요. 그동안 매달 받은 할인액(Pro 30,000원, Max 60,000원 × 청구된 달 수)과, 무료로 해 드린 방문 세팅비 300,000원만 돌려주시면 돼요. 관리자 화면 '요금제' 에 지금 해지하면 얼마인지 늘 적혀 있어요.",
  },
  {
    title: "한도를 넘었을 때",
    body:
