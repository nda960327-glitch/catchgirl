  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-frame p-6">
      <div className="w-full max-w-sm rounded-[28px] bg-card p-7 shadow-pop">
        ...
        <p className="mt-2 text-[11px] text-mute">매장을 열고 싶은 업체라면 <Link href="/signup" className="font-bold text-brand underline-offset-2 hover:underline">가입 신청</Link>으로 가세요.</p>
        {enabled ? (
          <PlatformLoginForm />
        ) : (
