...
const ACTION_LABEL: Record<string, string> = {
  ...
  BROADCAST: "전체 공지", STORE_DELETED: "매장 삭제", SIGNUP: "가입 신청", APPROVED: "가입 승인", BIZ_VERIFIED: "사업자 확인", CMS_UPDATED: "자동이체 정보", AGENT_SIGNUP: "담당직원 가입", AGENT_CREATED: "담당직원 생성", REPORTED: "신고 접수", REPORT_CLOSED: "신고 처리", ACCOUNT_DELETED: "손님 계정 삭제",
};
