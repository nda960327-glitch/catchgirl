...
export default async function BartenderDetail({ params }: { params: Promise<{ slug: string; id: string }> }) {
  ...
  const [stats, reviews, comments, fav] = await Promise.all([
    staffStats(staff.id),
  ...
  return (
    <div className="flex min-h-full flex-col">
      ...
      <ProfileClient
        slug={slug}
        staff={{ id: staff.id, nickname: staff.nickname, bio: staff.bio, tags: parseJsonArray(staff.tags), photos: parseJsonArray(staff.photos) }}
