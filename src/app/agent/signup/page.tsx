    ...
    <div className="flex min-h-dvh items-center justify-center bg-frame p-6">
      <div className="w-full max-w-md rounded-[28px] bg-card p-7 shadow-pop">
        ...
        <div className="mt-3 grid grid-cols-3 gap-2 text-[11px]">
          ...
          <div className="rounded-xl bg-well p-2.5 text-center"><div className="text-mute">방문 세팅까지</div><div className="font-bold text-brand">+{won(COMMISSION.ONSITE)}</div></div>
        </div>
        <div className="mt-1 text-[10px] text-mute">매장 첫 출금이 성공한 달에 확정되고, 운영사가 그달 정산 때 지급해요. 무약정 매장은 커미션이 없어요.</div>
        <AgentSignupForm />
