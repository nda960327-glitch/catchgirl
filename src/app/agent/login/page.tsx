  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-frame p-6">
      <div className="w-full max-w-sm rounded-[28px] bg-card p-7 shadow-pop">
        ...
        <AgentLoginForm />
        <div className="mt-4 text-center text-[11px] text-mute">처음이세요? <Link href="/agent/signup" className="font-bold text-brand underline-offset-2 hover:underline">담당직원 가입</Link> — 코드가 바로 나와요</div>
      </div>
    </div>
  );
}
